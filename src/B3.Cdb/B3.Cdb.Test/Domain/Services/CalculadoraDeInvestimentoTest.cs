...
namespace B3.Cdb.Test.Domain.Services
{
    ...
    public class CalculadoraDeInvestimentoTest
    {
        ...
        [Fact]
        public void Deve_Retornar_Zero_Para_Valores_Bruto_Liquido_Se_Valor_Inicial_For_Zero()
        {
            // Arrange
        ...
        [Fact]
        public void Deve_Retornar_Zero_Para_Valores_Bruto_Liquido_Se_Prazo_For_Negativo()
        {
            // Arrange
        ...
        [Fact]
        public void Deve_Retornar_Zero_Para_Valores_Bruto_Liquido_Se_Prazo_For_Zero()
        {
            // Arrange
        ...
        [Fact]
        public void Deve_Retornar_Zero_Para_Valores_Bruto_Liquido_Se_Prazo_For_Um()
        {
            // Arrange
            var investimento = new Investimento(1000, 1);
